...
This is a modified version of RenderForCNN in which I genereate random trajectories around the chairs from ShapeNet depending on the viewpoints from Pascal3D. The images are rendered by moving cameras on these trajectories
